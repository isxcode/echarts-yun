package com.isxcode.rainbow.modules.user.mapper;

import com.isxcode.rainbow.api.user.constants.RoleType;
import com.isxcode.rainbow.api.user.constants.UserStatus;
import com.isxcode.rainbow.api.user.pojos.req.AddUserReq;
import com.isxcode.rainbow.api.user.pojos.req.UpdateUserReq;
import com.isxcode.rainbow.api.user.pojos.req.UpdateUserInfoReq;
import com.isxcode.rainbow.api.user.pojos.res.PageEnableUserRes;
import com.isxcode.rainbow.api.user.pojos.res.PageUserRes;
