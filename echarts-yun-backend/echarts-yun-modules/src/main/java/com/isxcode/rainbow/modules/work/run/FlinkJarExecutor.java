package com.isxcode.rainbow.modules.work.run;
...
import com.isxcode.rainbow.api.work.pojos.dto.JarJobConfig;
import com.isxcode.rainbow.api.work.pojos.res.RunWorkRes;
...
import com.isxcode.rainbow.backend.api.base.properties.IsxAppProperties;
...
import com.isxcode.rainbow.common.utils.path.PathUtils;
...
import com.isxcode.rainbow.modules.file.repository.FileRepository;
import com.isxcode.rainbow.modules.file.service.FileService;
...
import static com.isxcode.rainbow.common.utils.ssh.SshUtils.scpJar;
    ...
    protected void execute(WorkRunContext workRunContext, WorkInstanceEntity workInstance) {
        ...
        try {
            scpJar(scpFileEngineNodeDto, fileDir + File.separator + jarFile.getId(),
                engineNode.getAgentHomePath() + File.separator + "zhishiyun-agent" + File.separator + "file"
