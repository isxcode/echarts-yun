...
import com.isxcode.rainbow.api.agent.pojos.req.AcornPluginReq;
...
import com.isxcode.rainbow.modules.datasource.service.DatasourceService;
import com.isxcode.rainbow.modules.file.repository.FileRepository;
import com.isxcode.rainbow.modules.func.mapper.FuncMapper;
...
public class FlinkSqlExecutor extends WorkExecutor {
    ...
    protected void execute(WorkRunContext workRunContext, WorkInstanceEntity workInstance) {
        ...
        // 开始构造flinkSubmit
        SubmitJobReq submitJobReq = SubmitJobReq.builder().entryClass("com.isxcode.rainbow.plugin.sql.execute.Job")
            .agentHomePath(engineNode.getAgentHomePath()).appResource("flink-sql-execute-plugin.jar")
            .appName("zhishiyun-job").workInstanceId(workInstance.getId())
