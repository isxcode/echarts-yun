package com.isxcode.rainbow.modules.monitor.service;
...
import com.isxcode.rainbow.api.api.constants.ApiStatus;
import com.isxcode.rainbow.api.cluster.constants.ClusterNodeStatus;
import com.isxcode.rainbow.api.cluster.constants.ClusterStatus;
import com.isxcode.rainbow.api.cluster.pojos.dto.ScpFileEngineNodeDto;
import com.isxcode.rainbow.api.datasource.constants.DatasourceStatus;
import com.isxcode.rainbow.api.instance.constants.InstanceStatus;
import com.isxcode.rainbow.api.main.properties.SparkYunProperties;
import com.isxcode.rainbow.api.monitor.constants.MonitorStatus;
import com.isxcode.rainbow.api.monitor.pojos.ao.MonitorLineAo;
import com.isxcode.rainbow.api.monitor.pojos.ao.WorkflowMonitorAo;
...
import com.isxcode.rainbow.api.monitor.pojos.dto.SystemMonitorDto;
import com.isxcode.rainbow.api.monitor.pojos.dto.WorkflowInstanceLineDto;
import com.isxcode.rainbow.api.monitor.pojos.req.GetClusterMonitorReq;
import com.isxcode.rainbow.api.monitor.pojos.req.GetInstanceMonitorReq;
import com.isxcode.rainbow.api.monitor.pojos.req.PageInstancesReq;
import com.isxcode.rainbow.api.monitor.pojos.res.GetClusterMonitorRes;
import com.isxcode.rainbow.api.monitor.pojos.res.GetInstanceMonitorRes;
import com.isxcode.rainbow.api.monitor.pojos.res.GetSystemMonitorRes;
import com.isxcode.rainbow.api.monitor.pojos.res.PageInstancesRes;
import com.isxcode.rainbow.api.workflow.constants.WorkflowStatus;
import com.isxcode.rainbow.backend.api.base.exceptions.IsxAppException;
import com.isxcode.rainbow.common.utils.AesUtils;
import com.isxcode.rainbow.modules.api.repository.ApiRepository;
import com.isxcode.rainbow.modules.cluster.entity.ClusterNodeEntity;
import com.isxcode.rainbow.modules.cluster.mapper.ClusterNodeMapper;
import com.isxcode.rainbow.modules.cluster.repository.ClusterNodeRepository;
import com.isxcode.rainbow.modules.cluster.repository.ClusterRepository;
import com.isxcode.rainbow.modules.datasource.repository.DatasourceRepository;
import com.isxcode.rainbow.modules.monitor.entity.MonitorEntity;
import com.isxcode.rainbow.modules.monitor.mapper.MonitorMapper;
import com.isxcode.rainbow.modules.monitor.repository.MonitorRepository;
import com.isxcode.rainbow.modules.workflow.entity.WorkflowInstanceEntity;
import com.isxcode.rainbow.modules.workflow.mapper.WorkflowMapper;
import com.isxcode.rainbow.modules.workflow.repository.WorkflowInstanceRepository;
...
import com.isxcode.rainbow.api.monitor.constants.TimeType;
...
import static com.isxcode.rainbow.common.config.CommonConfig.JPA_TENANT_MODE;
import static com.isxcode.rainbow.common.config.CommonConfig.TENANT_ID;
import static com.isxcode.rainbow.common.utils.ssh.SshUtils.executeCommand;
import static com.isxcode.rainbow.common.utils.ssh.SshUtils.scpFile;
