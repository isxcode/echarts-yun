package com.isxcode.rainbow.modules.work.service.biz;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.isxcode.rainbow.api.agent.constants.AgentApi;
...
import com.isxcode.rainbow.api.work.constants.WorkType;
import com.isxcode.rainbow.api.work.exceptions.WorkRunException;
import com.isxcode.rainbow.api.work.pojos.dto.*;
import com.isxcode.rainbow.api.work.pojos.req.*;
import com.isxcode.rainbow.api.work.pojos.res.*;
import com.isxcode.rainbow.backend.api.base.exceptions.IsxAppException;
import com.isxcode.rainbow.common.utils.http.HttpUrlUtils;
import com.isxcode.rainbow.common.utils.http.HttpUtils;
...
import com.isxcode.rainbow.modules.work.mapper.WorkConfigMapper;
import com.isxcode.rainbow.modules.work.mapper.WorkMapper;
...
import com.isxcode.rainbow.modules.work.service.WorkConfigService;
import com.isxcode.rainbow.modules.work.service.WorkService;
...
public class WorkBizService {
    ...
    public void stopJob(StopJobReq stopJobReq) {
        ...
        if (InstanceType.MANUAL.equals(workInstanceEntity.getInstanceType())) {
            ...
            com.isxcode.rainbow.api.agent.pojos.req.StopJobReq agentStopReq =
                com.isxcode.rainbow.api.agent.pojos.req.StopJobReq.builder().jobId(submitJobRes.getJobId())
