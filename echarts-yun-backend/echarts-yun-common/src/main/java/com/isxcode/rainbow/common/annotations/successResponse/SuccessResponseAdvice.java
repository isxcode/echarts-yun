package com.isxcode.rainbow.common.annotations.successResponse;
...
public class SuccessResponseAdvice {
    ...
    @Pointcut("@annotation(com.isxcode.rainbow.common.annotations.successResponse.SuccessResponse)")
