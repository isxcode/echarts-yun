package com.isxcode.rainbow.common.userlog;
...
import com.isxcode.rainbow.backend.api.base.exceptions.SuccessResponseException;
...
public class UserLogAdvice {
    ...
    @Pointcut("@annotation(com.isxcode.rainbow.common.userlog.UserLog)")
