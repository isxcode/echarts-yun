...
import com.isxcode.rainbow.api.api.constants.PathConstants;
import com.isxcode.rainbow.api.work.constants.WorkType;
import com.isxcode.rainbow.backend.api.base.exceptions.AgentResponseException;
...
public class KubernetesAcorn implements AcornRun {
    ...
    public SubmitJobRes submitJob(SubmitJobReq submitJobReq) {
        ...
        flinkConfig.set(KubernetesConfigOptions.CLUSTER_ID, "zhishiyun-cluster-" + System.currentTimeMillis());
        ...
        flinkConfig.set(KubernetesConfigOptions.NAMESPACE, "zhishiyun-space");
        flinkConfig.set(KubernetesConfigOptions.KUBERNETES_SERVICE_ACCOUNT, "zhishiyun");
    ...
    public GetJobInfoRes getJobInfo(GetJobInfoReq getJobInfoReq) {
        ...
        String getStatusJobManagerFormat = "kubectl get pods -l app=%s -n zhishiyun-space";
        String line;
        ...
        try {
            ...
            try (InputStream inputStream = process.getInputStream();
                ...
                if (errLog.toString().isEmpty()) {
                    ...
                    if (errLog.toString().contains("No resources found in zhishiyun-space namespace")) {
