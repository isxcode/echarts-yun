<template>
  ...
  <div class="footer">
    ...
    <div class="content">
      <div class="left">
        <img class="logo-img" src="https://isxcode.oss-cn-shanghai.aliyuncs.com/zhishiyun/web-img/logo.jpg" alt=""/>
        <div class="logo-name">
          至爻数据
        </div>
...
function downloadLicense() {
  window.open("https://isxcode.oss-cn-shanghai.aliyuncs.com/zhishiyun/license.lic");
}

function downloadPackage() {
  window.open("https://isxcode.oss-cn-shanghai.aliyuncs.com/zhishiyun/zhishiyun.tar.gz");
}
